...
import 'package:tugas_flutter/list_profile.dart';
// Tambahkan dua import ini agar DetailProfile dan Profile dikenali
import 'package:tugas_flutter/profile_page.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  String nama = "I Made Restu Adi Wijaksara";
  String nim = "2415354037";
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Text('Nama: $nama', style: const TextStyle(fontSize: 24)),
            const SizedBox(height: 10),
            Text('NIM: $nim', style: const TextStyle(fontSize: 24)),
